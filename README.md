<img width="1617" height="1457" alt="屏幕截图 2026-08-21 131619" src="https://github.com/user-attachments/assets/38ab5ba3-a36a-4a66-99af-b3002886e6a8" /><div align="center">
  ...
  <p>
    <a href="https://github.com/foorgange/VidFlow/stargazers"><img src="https://img.shields.io/github/stars/foorgange/VidFlow?style=flat-square" alt="GitHub Stars"></a>
...
- **Function Calling 与连续追问** — 基于 LangChain4j + Function Calling 实现结构化信息查询与精准总结，并利用 Redis 保存会话上下文，支持基于历史对话的连续追问。
